...
namespace TIEconomyMod
{
    ...
    public static class WelfareInequalityEffectPatch
    {
        ...
        public static bool GetWelfarePriorityInequalityChangeOverwrite(ref float __result, TINationState __instance)
        {
            ...
            //singleInvestChange = 0.10 / (30,000 * population / 10,000,000,000) = (0.10 * 333333) / population = 33333 / population
            //So a single welfare investment should decrease the country's inequality by 33333 / population

            //Example: A country has 600 Bn GDP and 20 Mn population. It thus has 60 IP. It can complete 60 welfare investments a month.
            //Each investment should decrease inequality by 33333/20,000,000 = 0.00167
            //60 investments a month thus reduces inequality by 0.1002, the desired amount, as the GDP per capita is 30k

            //Example2: The country's GDP is doubled, so its per-capita GDP is 60k instead of 30k. It has 1,200 Bn GDP, for 120 IP.
            //Each investment still removes 0.00167 inequality, as this is a function only of population which is still 20 million.
            //120 investments a month removes 0.2004 inequality a month, twice the amount due to twice the economic expense for the same population.
