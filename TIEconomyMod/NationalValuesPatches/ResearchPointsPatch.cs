...
namespace TIEconomyMod
{
    ...
    public static class ResearchPointsPatch
    {
        ...
        public static bool GetResearchMonthOverwrite(ref float __result, TINationState __instance)
        {
            ...
            //The goal is for research points to roughly equal 1.5-2 times the control cost of the nation, for a sufficiently educated and wealthy nation
            ...
            float populationResearch = __instance.population_Millions * 0.00225f; //Removed better-than-linear scaling, kept vanilla 0.00225f

            float educationEffect = Mathf.Pow(__instance.education, 2f); //Vanilla, get 100x research at 10 education than at 1

            float gdpPerCapEffect = Mathf.Max(__instance.perCapitaGDP / 15000f, 0.5f); //Floored at 50% research at 7500 gdp per capita, 200% at 30k, and indefinitely upward
            ...
            __result = populationResearch * educationEffect * gdpPerCapEffect * democracyEffect * cohesionEffect * unrestEffect * advisorBonus;
