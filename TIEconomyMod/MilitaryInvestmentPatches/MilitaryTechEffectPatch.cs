...
namespace TIEconomyMod
{
    ...
    public static class MilitaryTechEffectPatch
    {
        ...
        public static bool GetMilitaryPriorityTechLevelChangeOverwrite(ref float __result, TINationState __instance)
        {
            ...
            float idealMilTechGain = 4167f / __instance.population;
            ...
            float expectedUnrestReduction = 111111f / __instance.population; //This is pulled from MilitaryUnrestEffectPatch. It is the amount of unrest a military investment would remove at 0 democracy and >> 0 unrest
