...
namespace TIEconomyMod
{
    ...
    public static class KnowledgeCohesionEffectPatch
    {
        ...
        public static bool GetKnowledgePriorityCohesionChangeOverwrite(ref float __result, TINationState __instance)
        {
            ...
            //I want an cohesion centering rate of 0.05 a month for a 30k GDP per capita nation
            //Using the same method as with the welfare inequality, this gives me a single investment effect of 16667 / population cohesion change
            ...
            float cohesionChangeAmount = Math.Min(Mathf.Abs(__instance.cohesion - 5f), (16667 / __instance.population)); //Calculate the amount of change and prevent overshooting 5
            if (__instance.cohesion > 5)
            {
